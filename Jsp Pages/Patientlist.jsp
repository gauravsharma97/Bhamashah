...
<div data-spy="scroll" data-target="#navbar-example" data-offset="0" 
	style="height:90%;overflow:auto; position: relative;text-align:center;overflow-x:hidden ">
	  <div class="row">
	    ...
	    <div class="row row-padding" style="text-align:center;">
	        <div class="col-xs-6" style="font-size:30px"><strong style="color:black">Bhamashah Id</strong></div>
	        <div class="col-xs-6" style="font-size:30px"><strong style="color:black">Patient Name</strong></div>
	    </div>
	<jsp:useBean id="pat" class="LoginConsole.Patientlist"></jsp:useBean>
	...
	<%  
	    ...
	    vc1=pat.fetchname(session.getAttribute("hospitalid").toString());
		for(int i=0;i<vc.size();i++)
		{
			out.print( "<div class='row row-padding' text-align=center style='text-align:center'>");
			out.print("<div class='col-xs-6' style='font-size:20px;color:black'>"+vc.elementAt(i)+"</div>");
			out.print("<div class='col-xs-6' style='font-size:20px;color:black'>"+vc1.elementAt(i)+"</div></div>");			
		}
	%>
	</div>
</div>
