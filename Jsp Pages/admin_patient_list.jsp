...
<%@page import="DataFetch.Admin_patient_list"%>
<html>
<head>
...
<div data-spy="scroll" data-target="#navbar-example" data-offset="0" 
	style="height:90%;overflow:auto; position: relative;text-align:center;overflow-x:hidden ">
	  <div class="row">
	    ...
	    <div class="row row-padding" style="text-align:center">
	        <div class="col-xs-3" style="font-size:30px"><strong>HospitalName</strong></div>
	        <div class="col-xs-3" style="font-size:30px"><strong>Address</strong></div>
	        <div class="col-xs-3" style="font-size:30px"><strong>Ack_ID</strong></div>
	        <div class="col-xs-3" style="font-size:30px"><strong>Patient_Name</strong></div>
	...
	<%
		...
		Admin_patient_list hl = new Admin_patient_list();
		hl.search();
		...
		for(int i=0;i<v1.size();i++)
		{
			...
			out.print("<div class='col-xs-3' style='font-size:20px'>"+v1.elementAt(i)+"</div>");
			out.print("<div class='col-xs-3' style='font-size:20px'>"+v2.elementAt(i)+"</div>");
			out.print("<div class='col-xs-3' style='font-size:20px'>"+v3.elementAt(i)+"</div>");
			out.print("<div class='col-xs-3' style='font-size:20px'>"+v4.elementAt(i)+"</div>");
